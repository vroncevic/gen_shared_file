...
class SHFSetup(object):
    """
        Define class SHFSetup with attribute(s) and method(s).
        Generate project skeleton for shared files.
        It defines:
            attribute:
            ...
            method:
                ...
                gen_shf_setup - Generate project skeleton
    """
    ...
    def __init__(self, verbose=False):
        """
            ...
            :exceptions: None
        """
        verbose_message(SHFSetup.VERBOSE, verbose, 'Initial setup')
        pass

    def gen_shf_setup(self, project_name, verbose=False):
        """
