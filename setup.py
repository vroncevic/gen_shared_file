...
'''
 ...
 Info
     Define setup for tool gen_shared_file.
'''
...
setup(
    ...
    packages=[
        'gen_shared_file', 'gen_shared_file.pro',
    ],
    install_requires=['ats-utilities'],
    package_data={
        'gen_shared_file': [
            'conf/gen_shared_file.logo',
            'conf/gen_shared_file.cfg',
            'conf/gen_shared_file_util.cfg',
            'conf/template/generator_test.template',
            'log/gen_shared_file.log'
        ]
    },
    data_files=[(
        '/usr/local/bin/', [
            '{0}{1}'.format(TOOL_DIR, 'run/gen_shared_file_run.py')
        ]
    )]
)
